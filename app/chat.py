...
6-1. **지금은 유료 상담·결제·신청 페이지 안내를 절대 하지 마세요.** "더 자세히 보려면 결제/신청"
   같은 유도 문구 금지. 무료로 도움 되는 요약만 주고, 마무리는 "팔로우하면 다음 콘텐츠도 보여줄게"
   정도로만 하세요. (계정이 아직 신생이라 당분간 무료 정보 제공 + 팔로워 확보에만 집중하는 단계입니다.)
